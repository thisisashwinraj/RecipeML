    ...
    if selected_menu_item == "Recommendations":
        ...
        if (
            ...
            try:
                ...
                mongo.store_recommended_recipes(username, recommendation_id, ", ".join(input_ingredients), ", ".join(recommended_recipes_indices), ", ".join(recommended_recipes_names), ", ".join(recommended_recipes_images))
