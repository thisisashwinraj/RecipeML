        ...
        if flag_display_result:  # Check if any result has been generated, to display
            ...
            with gif_image:
                ...
                try:
                    ...
                    blob_url_primary_image = azure_storage_account.store_image_in_blob_container(generated_primary_image_path, recipe_id + "_primary.png")
                    blob_url_secondary_image = azure_storage_account.store_image_in_blob_container(generated_secondary_image_path, recipe_id + "_secondary.png")
                
                except Exception as error: blob_url_primary_image, blob_url_secondary_image = "Unavailable"
            ...
            **Enjoy the wordplay, but cook with caution!**
            ...
            try:
                ...
                else: input_query = input_recipe_name

                mongo.store_generated_recipes(username, recipe_generation_type, input_query, selected_language, recipe_id, recipe_title, recipe_ingredients, recipe_instructions, serving_size, preperation_time_in_mins, calories_in_recipe, blob_url_primary_image, blob_url_secondary_image)
